...
#Telegram token
token = os.getenv('6791658727:AAHOcnxXSNfXNLAyq21HhL8iK1jg2ggWBSY')
bot_number = os.getenv('1')
...
def CFBUAM(update: Update, context: CallbackContext):
  ...
  update.message.reply_text(f"METHOD: CFBUAM L7 THREADS : 400\n\nCFBUAM: CloudFlare Under Attack Mode Bypass (Met un referrer : Zalo: https://zalo.me/g/fcrvox433 ou un site du genre pour bypass) pour: {s} s")
  url_str = str(url)
  print(url_str)
